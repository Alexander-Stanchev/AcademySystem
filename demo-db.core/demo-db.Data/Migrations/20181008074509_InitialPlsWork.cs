...
{
    public partial class InitialPlsWork : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Assaignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Assaignments_Courses_CourseId",
                        column: x => x.CourseId,
